...
def main(args):
    ...
    #model.load_state_dict(torch.load('../models/model-1-600.ckpt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type = str, default = '../models_noweight/', help = 'path for saving trained models')
