...
def main(args):
    ...
    model.load_state_dict(torch.load('../model/models_column/model-32-304.ckpt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--model_path', type = str, default = '../model/models_column/', help = 'path for saving trained models')
    ...
    parser.add_argument('--save_step', type = int, default = 304, help = 'step size for saving trained models')
