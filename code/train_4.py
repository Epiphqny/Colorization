...
def main(args):
    ...
    model.load_state_dict(torch.load('../model/models/model-18-480.ckpt'))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--save_step', type = int, default = 480, help = 'step size for saving trained models')
